...
def listarProyecto(request):
    ...
    return render(request, "proyecto/proyecto.html", data)
...
def listarDocumento(request):
    ...
    return render(request, "proyecto/documento.html", data)
...
def eliminarDocumento(request, id):
    ...
    item.delete()
    return redirect("/proyecto/documentos")
...
def crearActividad(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            messages.success(request, "Actividad creado con éxito!!!")
    return render(request, "proyecto/createProyecto.html", data)
...
def listarActividad(request):
    ...
    return render(request, "proyecto/actividad.html", data)
...
def eliminarActividad(request, id):
    item = Actividad.objects.get(pk=id)
    item.delete()
    return redirect("/proyecto/actividades")
